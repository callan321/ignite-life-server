...
public class BookingRuleBlockedPeriodService(ApplicationDbContext dbContext)
{
    ...
    public async Task<ServiceResult<BookingRuleBlockedPeriodDto>> CreateBlockedPeriodAsync(CreateBookingRuleBlockedPeriodRequest dto)
    {
    ...
    public async Task<ServiceResult<BookingRuleBlockedPeriodDto>> UpdateBlockedPeriodAsync(UpdateBookingRuleBlockedPeriodRequest dto)
    {
        ...
        if (await IsOverlappingWithExistingAsync(dto.StartDateTime ?? entity.StartDateTime,
                                                 dto.EndDateTime ?? entity.EndDateTime, dto.Id))
